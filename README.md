...
- 노란색 : DB로부터 추출, 파란색 : P로부터 추출, 빨간색 : 새로 생성한 컬럼 (2023_메뉴얼 PDF 참조바람)
- 중복되는 내용은 패스함.
...
- 작업 순서나 프로세스는 작업 보고서를 참조해주세요.
- 코드는 깃허브에 올린 주피터 노트북 파일을 참조해주세요.
- 코드는 기호에 따라 참고해주세요. 중간과정을 txt 파일로 자주 저장했으나 생략해도 됩니다.
